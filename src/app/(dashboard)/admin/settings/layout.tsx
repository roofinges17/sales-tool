...
const NAV_GROUPS_FULL = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/settings/ai-vision/",    label: "Gemini AI",       icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.347.347a3.75 3.75 0 00-.864 3.5A2.75 2.75 0 0112 21.75a2.75 2.75 0 01-2.743-2.563 3.75 3.75 0 00-.864-3.5l-.347-.347z" },
